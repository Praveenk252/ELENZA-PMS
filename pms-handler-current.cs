...
public class PmsApiHandler : IHttpHandler, IRequiresSessionState
{
    ...
    private void HandleProductionAction(HttpContext context)
    {
        using (var conn = OpenConnection(context))
        {
            ...
            if (queueEntry == null && string.Equals(stationName, "Packing", StringComparison.OrdinalIgnoreCase))
    ...
    {
        if (!string.Equals(S(station, "machine_name"), "Packing", StringComparison.OrdinalIgnoreCase))
            return null;
